...
fit.eog.models <- dget("/group/mlr-lab/Saskia/ECoG_LASSO/scripts/fit_eog_models.r")
fit.all.eog.models <- dget("/group/mlr-lab/Saskia/ECoG_LASSO/scripts/fit_all_eog_models.r")

path = paste(args$arg1, sep = "")
fit.all.eog.models(path)
